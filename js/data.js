...
{id:'spring',name:'Spring',kicker:'SEASON 1 OF 4',
 ...
 phases:[
  ...
  {n:'4',t:'Spring 14 to 28',when:'days 14 to 28',steps:[
   ...
   {id:'sp4m',t:'When Demetrius asks about the cave (the morning after 25,000g earned): pick fruit bats.',w:'About one fruit a night: 80% wild berries, 20% tree fruit (Cherry, Pomegranate, Peach, Orange, Apricot 3.6% each, Apple 2%). Over the year that is a Pomegranate for Enchanter’s and enough tree fruit for the Artisan bundle without a 6,000g sapling. Apples are too rare to count on, hence the tree on Summer 1. The mushroom option is covered by the miner on floors 81 and up.',tags:['bundle'],p:0},
...
{id:'summer',name:'Summer',kicker:'SEASON 2 OF 4',
 ...
 phases:[
  {n:'1',t:'Summer 1 to 3',when:'days 1 to 3',steps:[
   {id:'su1h',t:'Summer 1: an Apple sapling on a clear 3 by 3 with nothing touching it.',c:'Apple Sapling: 4,000g',w:'Trees take 28 days to mature and fruit only in their season: planted Summer 1 it gives an apple a day all Fall. The Fodder bundle needs 3 Apples and the cave gives about two a year. Anything in the 8 tiles around it stops it growing. If 4,000g is too much on Summer 1, plant it by Summer 20 (8 apples) or buy 3 at the cart (300g to 1,000g each).',tags:['farm','bundle','deadline','shop'],p:1,risk:'by Summer 1'},
...
{id:'fall',name:'Fall',kicker:'SEASON 3 OF 4',
 ...
 phases:[
  ...
  {n:'3',t:'Fall 4 to 15',when:'days 4 to 15',steps:[
   ...
   {id:'fa3b',t:'Apples from the tree, tree fruit from the cave: keep 3 Apples for Fodder, 2 fruits for Artisan, 1 Pomegranate for Enchanter’s.',w:'The tree gives one apple a day all Fall. The bats drop about one fruit a night, mostly berries; any tree fruit counts for Artisan. A missing Pomegranate is 420g to 1,000g at the cart.',tags:['bundle'],p:1},
...
var BRIEF = {
 seasons:{
  spring:{must:['Spring forage: Leek, Daffodil, Dandelion, Wild Horseradish','Spring 13: Strawberry Seeds and the Spring Crops bundle','Steel Axe ordered by Spring 27','Fruit bats when Demetrius asks'],money:'8,000g to 15,000g by Spring 28'},
  summer:{must:['Summer 1: blueberries and the Apple sapling in','Pufferfish, sunny, noon to 4pm','Secret Woods: Fiddlehead Fern, Woodskip','Vault: 2,500g and 5,000g paid'],money:'20,000g to 40,000g by Fall 1'},
